...
<script>
	function actvloader() {
		swal({title: "Loading...", text: "Please wait while page loads.", imageUrl: "./public/images/loader/green-loader.gif", showConfirmButton: false, allowOutsideClick: false});
	}
