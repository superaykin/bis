<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      $res = query("INSERT INTO entity (eid, lastname, firstname, middlename, suffix, sex, birthdate, birthplace, birthorder, address_city, address_brgy, address_street,
        ethnicity, religion, ips, 4ps, pwd, contactno, actor_id, registered, profile_remarks, birth_registered) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
        ...
        $ips, $fps, $pwd, $contact, $actor, $created_date, $remarks, $birthregistered);
      if($res === false) {
